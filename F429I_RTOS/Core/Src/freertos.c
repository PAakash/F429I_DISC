...
osThreadId touchUpdateHandle;
osThreadId usbProcessHandle;
...
/* USER CODE BEGIN Header_statusTaskFcn */
/**
...
void statusTaskFcn(void const * argument)
{
  ...
  /* USER CODE END statusTaskFcn */
}

/* USER CODE BEGIN Header_displayUpdateFcn */
/**
...
void displayUpdateFcn(void const * argument)
{
  ...
  /* USER CODE END displayUpdateFcn */
}

/* USER CODE BEGIN Header_touchUpdateFcn */
/**
* @brief Function implementing the touchUpdate thread.
* @param argument: Not used
* @retval None
*/
...
void touchUpdateFcn(void const * argument)
{
  ...
  /* USER CODE END touchUpdateFcn */
}

/* USER CODE BEGIN Header_usbProcessFcn */
/**
